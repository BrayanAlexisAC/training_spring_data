-- TRUNCATE TABLES --> Eliminate all information

-- INSERT CUSTOMERS
INSERT INTO pizza_customer (id_customer, name, address, email, phone_number)
VALUES
...
-- INSERT ORDERS
INSERT INTO pizza_order (id_customer, created_date, total_price, method, additional_notes)
VALUES
('192758012', dateadd(DD, +5, cast(getdate() as date)), 42.95, 'D', 'Do not be late pls.'),
('474771564', dateadd(DD, +4, cast(getdate() as date)), 62.0, 'S', null),
('182120056', dateadd(DD, +3, cast(getdate() as date)), 22.0, 'C', null),
('617684636', dateadd(DD, +2, cast(getdate() as date)), 42.0, 'S', null),
('192758012', dateadd(DD, +1, cast(getdate() as date)), 20.5, 'D', 'Please bring the jalapeños separately.'),
('782668115', getdate(), 23, 'D', null);

-- INSERT ORDER ITEMS
INSERT INTO pizza_order_item (id_order, id_item, id_pizza, quantity, price)
VALUES
(1, 1, 1, 1, 23.0),
(1, 2, 4, 1, 19.95),
(2, 1, 2, 1, 18.5),
